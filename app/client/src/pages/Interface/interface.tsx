            ...
            <div className="container mx-auto py-8 px-4 max-w-4xl">
                        ...
                        return (
                            <div key={question.id} className="border-b pb-8">
                                ...
                                <div className="flex items-center gap-4 mt-4">
                                    ...
                                    <Slider value={[question.difficulty]} min={1} max={3} step={1} onValueChange={(value) => handleQuestionChange(question.id, "difficulty", value[0])} className="w-[20%]" />
                ...
                <div className="mt-8">
                    <div className="flex flex-col items-center gap-2">
                        <Button onClick={handleAddQuestion} className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center hover:bg-blue-600">
                            <Plus className="h-5 w-5 text-white" />
                        </Button>
                    </div>
                    {!quizReady && numQuestions === 0 && <h2 className="text-lg font-bold text-center mb-6">Add a question to get started</h2>}
                </div>
                    ...
                    {quizReady && (
                        <>
                            <div className="flex gap-4 w-full justify-center">
                                ...
                                <Button className="w-1/5 px-8 bg-gray-200" variant="secondary" onClick={() => setConfirmResetModalOpen(true)}>
